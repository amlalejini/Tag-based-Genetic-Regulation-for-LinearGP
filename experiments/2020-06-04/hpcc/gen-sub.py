...
job_name = "bcalc"
executable = "bool-calc-exp_tag-len-512_match-metric-streak_thresh-0_reg-mult"

config = {
    "PROGRAM": [
        "-USE_FUNC_REGULATION 1 -USE_GLOBAL_MEMORY 1 -MUT_RATE__INST_TAG_BF 0.0001 -MUT_RATE__FUNC_TAG_BF 0.0001",
        "-USE_FUNC_REGULATION 1 -USE_GLOBAL_MEMORY 1 -MUT_RATE__INST_TAG_BF 0.00005 -MUT_RATE__FUNC_TAG_BF 0.00005",
        "-USE_FUNC_REGULATION 1 -USE_GLOBAL_MEMORY 1 -MUT_RATE__INST_TAG_BF 0.00002 -MUT_RATE__FUNC_TAG_BF 0.00002",
        "-USE_FUNC_REGULATION 1 -USE_GLOBAL_MEMORY 1 -MUT_RATE__INST_TAG_BF 0.00001 -MUT_RATE__FUNC_TAG_BF 0.00001"
    ]
}
...
def main():
    ...
    combos = [f"{param}" for param in config["PROGRAM"]]
