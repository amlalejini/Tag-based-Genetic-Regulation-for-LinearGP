...
config = {
    "PROGRAM": [
        ...
        "-USE_FUNC_REGULATION 1 -USE_GLOBAL_MEMORY 1 -MUT_RATE__INST_TAG_SINGLE_BF 0.2 -MUT_RATE__FUNC_TAG_SINGLE_BF 0.2 -MUT_RATE__INST_TAG_SEQ_RAND 0.1 -MUT_RATE__FUNC_TAG_SEQ_RAND 0.05"
