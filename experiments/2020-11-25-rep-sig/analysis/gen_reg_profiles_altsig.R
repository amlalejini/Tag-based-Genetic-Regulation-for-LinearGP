...
data_dir <- "/home/amlalejini/devo_ws/Tag-based-Genetic-Regulation-for-LinearGP/experiments/2020-11-25-rep-sig/analysis/data/"
dump_dir <- "/home/amlalejini/devo_ws/Tag-based-Genetic-Regulation-for-LinearGP/experiments/2020-11-25-rep-sig/analysis/imgs/"
trace_img_dump_dir <- paste(dump_dir, "traces/", sep="")
trace_ids <- 20001:22400
generation <- 10000


max_fit_org_data_loc <- paste(data_dir, "max_fit_orgs_noprogram.csv", sep="")
...
for (trace_id in trace_ids) {
  ...
  trace_file <- paste(data_dir,
                      "reg-traces/trace-reg_update-", generation,
