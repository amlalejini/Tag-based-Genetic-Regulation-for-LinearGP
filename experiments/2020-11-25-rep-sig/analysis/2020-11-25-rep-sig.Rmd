# Signal-counting problem analysis
...
![](`r paste0(working_directory, "../../../media/signal-counting-task.png")`)
...
We confirmed that each difficulty level of the signal-counting problem is solvable without regulation using [hand-coded SignalGP programs](https://github.com/amlalejini/Tag-based-Genetic-Regulation-for-LinearGP/blob/master/documents/handcoded-examples.md).
...
1. We traced program execution step-by-step (including each function's regulatory state) during evaluation on the signal-counting task and extracted regulatory interactions between executing functions as a directed graph.
...
## All regulation traces

We generated regulation traces for every replicate: [https://osf.io/crdqf/](https://osf.io/crdqf/).