...
job_name = "chg-sig"
executable = "chg-env-exp_tag-len-256_match-metric-streak_thresh-0_reg-exp"
...
def main():
    ...
    combos = [f"{prog_param} {env_param}" for prog_param in config["PROGRAM"] for env_param in config["ENVIRONMENT"]]
