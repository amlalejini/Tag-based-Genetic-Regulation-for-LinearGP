---
title: "Demonstrating Genetic Regulation in SignalGP - Multicell Regulation Environment"
output: 
  pdf_document:
    toc: true
    toc_depth: 4
...
ggplot(filter(data, EPIGENETIC_INHERITANCE=="0"), aes(x=condition, y=score)) +
  geom_boxplot() +
